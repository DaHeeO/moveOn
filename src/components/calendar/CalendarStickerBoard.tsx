...
interface Props {
    ...
    selectedCategory: StickerCategoryKey;
}

const CalendarStickerBoard = ({ todayRef, pivotDate, updatePivotDate, monthlyDairy, selectedCategory }: Props) => {
    ...
    return (
        <div className="CalendarStickerBoard">
...
export default CalendarStickerBoard;
